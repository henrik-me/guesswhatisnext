...
echo ""
echo "Next steps:"
echo "  1. Run ./infra/setup-github.sh to configure GitHub secrets and variables"
echo "  2. After GitHub secrets and variables are configured, run the staging deploy workflow:"
echo "     gh workflow run staging-deploy.yml"
