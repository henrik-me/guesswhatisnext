...
echo "  3. Configure container registry credentials for deploy workflows:"
echo "     - Add GHCR_USERNAME variable and GHCR_PAT secret"
echo "     - See infra/README.md for details"
echo "  4. (Optional) Enable branch protection / rulesets on 'main'"
echo ""
