...
> **Last updated:** 2026-05-10T04:40Z
...
| CS80 | **Scores avg int overflow**<br>WT: `C:\src\guesswhatisnext_cs80`<br>B:&nbsp; `cs80-avg-bigint-cast` | implementing | yoga-gwn | 2026-05-10T04:40Z | — |
|  | _Cast `AVG(score)` to BIGINT in server/routes/scores.js:346-368 + reduce smoke sentinel score range. Operator-gated CS80-3 prod data cleanup explicitly NOT in scope for this PR (cast handles existing data). Sub-agent dispatched 2026-05-10T04:40Z. Plan: [active_cs80_scores-avg-int-overflow.md](project/clickstops/active/active_cs80_scores-avg-int-overflow.md). Closure includes the prod deploy that empirically validates CS73 + CS79 as side effects._ |  |  |  |  |
