...
> **Last updated:** 2026-05-01T17:55Z
...
| CS66-2a | **PR Body And Commit Trailer Gates**<br>WT: `C:\src\guesswhatisnext_wt\cs66-2a`<br>B:&nbsp; _(no PR yet)_ | claimed | yoga-gwn | 2026-05-01T17:55Z | _(none)_ |
|  | _Soak-window false-positive cleanup for `scripts/check-pr-body.js`. Audit of 40 recent PRs (yoga-gwn, 2026-05-01) found 3 false positives in the post-CS66 era (#311, #313, #314). Fixes: loosen `not applicable (<category>)` regex to allow inline clarification, accept hybrid category names (`docs+tooling`), accept `N/A` synonym, improve failure messages with canonical templates. Table-over-bullets requirement kept (per user direction). Re-audit gates the merge._ |  |  |  |  |
