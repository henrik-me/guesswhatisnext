...
> **Last updated:** 2026-04-23T03:06Z
...
|----------|---------|-------------|--------|-----------|
| yoga-gwn | HENRIKM-YOGA | C:\src\guesswhatisnext | 🟢 Active | 2026-04-23T03:06Z |
...
| — | — | implementing | yoga-gwn | C:\src\gwn-worktrees\wt-1 | yoga-gwn/adhoc-context-folder-pointers | — | 2026-04-23T03:06Z | Drop CONTEXT.md Clickstop Summary table; replace with folder pointers + git-pull reminder. Update INSTRUCTIONS/TRACKING/OPERATIONS/.github copilot-instructions accordingly. Rewire check-docs-consistency `no-orphan-active-work` rule to derive done-set from `project/clickstops/done/` filenames. Docs-only PR (no Copilot review per REVIEWS.md). | — |
