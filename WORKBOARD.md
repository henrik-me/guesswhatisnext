...
> **Last updated:** 2026-05-09T20:45Z
...
| CS78 | **Dependabot overrides may2026**<br>WT: `C:\src\guesswhatisnext_cs78`<br>B:&nbsp; `cs78-dependabot-overrides` | implementing | yoga-gwn | 2026-05-09T20:45Z | — |
|  | _Closing 3 open Dependabot alerts: #12 fast-xml-builder HIGH (CVE-2026-44665), #11 fast-xml-builder MEDIUM (CVE-2026-44664), #10 ip-address MEDIUM (CVE-2026-42338). Approach: move artillery optionalDeps→devDeps (eliminates fast-xml chain from prod), bump express-rate-limit 8.3.1→^8.5.1 (natively pulls ip-address ^10.2.0), plus overrides backstop. Sub-agent dispatched 2026-05-09T20:45Z. Plan: [active_cs78_dependabot-overrides-may2026.md](project/clickstops/active/active_cs78_dependabot-overrides-may2026.md)._ |  |  |  |  |
