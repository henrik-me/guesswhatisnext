...
> **Last updated:** 2026-05-10T03:20Z
...
| CS79 | **Api features cold init gate**<br>WT: `C:\src\guesswhatisnext_cs79`<br>B:&nbsp; `cs79-smoke-cold-init` | implementing | yoga-gwn | 2026-05-10T03:20Z | — |
|  | _Self-driving end-to-end CS picking up where CS73 closed: scripts/smoke.js step (b) /api/features missing X-User-Activity:1 header → cold-init 503 retry-after:5 forever → CS41-1 fail → auto-rollback. Fix is one-line in pollUntil + step b call site, plus regression test in tests/smoke.test.js, plus fresh-cold-init cycle in scripts/container-validate.js. Closure requires successful prod deploy without auto-rollback (this also delivers CS73's empirical prod-deploy validation). Sub-agent dispatched 2026-05-10T03:20Z. Plan: [active_cs79_api-features-cold-init-gate.md](project/clickstops/active/active_cs79_api-features-cold-init-gate.md)._ |  |  |  |  |
