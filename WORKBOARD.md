...
| CS52-4 | CS52 — mode picker + connectivity SM UI + claim modal | ready_to_merge | yoga-gwn-c5 | C:\src\gwn-worktrees\wt-cs52-4 | yoga-gwn-c5/cs52-4-impl | #268 | 2026-04-26T20:15Z | PR #268 in flight: mode picker (Practice/Ranked × Free Play/Daily), Ranked streaming flow against CS52-3 endpoints, connectivity banner consuming sync-client SM, accessible claim modal, mid-Ranked-disconnect overlay. Sub-agent `cs52-4-impl` still iterating (>1h+, 5 Copilot rounds processed). | -- |
| CS52-7d | CS52 — multiplayer storage + scoring path unification | ready_to_merge | yoga-gwn-c5 | C:\src\gwn-worktrees\wt-cs52-7d | yoga-gwn-c5/cs52-7d-impl | #279 | 2026-04-26T22:48Z | HEAD `0fc422e`. Rebased onto main (5a31660). 7 Copilot review iterations addressed (R1 timeout-event scoring parity + flake-resistant tests; R2 visible-loss logging + matchId rehydration; R3 DB-side timestamps for legacy MP tables + scoring parity assertion; R4 String(matchId) for ranked_sessions.match_id NVARCHAR; R5 same in test queries; R6 live/replay parity for match_players.score + meaningful test scoring + KQL replay path; R7 forfeit-zero in buildParticipantPayloads). R8 returned with **zero actionable comments**. CI green (Lint/Test/E2E/§4a/SW Cache/check-docs). Container validation passed 6 cycles. 875+ tests pass. mergeStateStatus=BLOCKED awaiting orchestrator merge (Copilot is COMMENTED not APPROVED). | -- |
