...
| CS64 | **Planning Conventions Deps And Parallelism**<br>WT: `C:\src\gwn-worktrees\wt-1`<br>B:&nbsp; `omni-gwn/cs64-planning-conventions` | claimed | omni-gwn | 2026-04-29T16:52Z | — |
|  | _Foundation CS for the CS64-67 sequence. Adds `**Depends on:** / **Parallel-safe with:**` frontmatter convention + dash-letter parallelism notation for task IDs to INSTRUCTIONS.md Quick Reference, TRACKING.md § Naming Conventions, OPERATIONS.md § Agent Work Model. Docs-only PR. Once merged, CS65/66/67 fan out in parallel._ |  |  |  |  |
