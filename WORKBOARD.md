...
> **Last updated:** 2026-05-01T19:35Z
...
| CS66-3 | **PR Body And Commit Trailer Gates**<br>WT: `C:\src\guesswhatisnext_wt\cs66-3`<br>B:&nbsp; _(no PR yet)_ | claimed | yoga-gwn | 2026-05-01T19:35Z | _(none)_ |
|  | _Promote check-pr-body and check-commit-trailers to required status checks. User direction 2026-05-01 cuts the CS66-2 soak short. Sub-agent updates failure messages with direct doc links, ensures each PR-body section's canonical spec is unambiguous in REVIEWS.md / OPERATIONS.md / CONVENTIONS.md, and adds a Quick Reference pointer in INSTRUCTIONS.md. After the PR merges, the orchestrator flips the two CS66 checks to required via the branch-protection API._ |  |  |  |  |
