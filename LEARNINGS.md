...
- [CS44 — WORKBOARD State Machine](project/clickstops/active/active_cs44_workboard-state-machine.md) — separate effort to harden the workboard's lifecycle and stale-lock handling (review.md findings 1, 3, 5).
