...
| CS60-2 | (umbrella) +7d cost-watch window. Daily sub-tasks recorded as CS60-2c (Day 3), CS60-2d (Day 4), CS60-2e (Day 5), CS60-2f (Day 6 partial), and CS60-2h (Day 7 partial — canonical "+7d" interpretation). Day 2 is recorded under CS60-1c and CS60-2g is unused in this split. | ✅ Done | 2026-04-27T22:39Z..2026-05-02T18:30Z | Closed by yoga-gwn 2026-05-02T18:30Z. Replaces CS54-8 second window. Days 6/7 cost has Cost Management closing-day lag and will retro-fill — will be amended during CS60-3i. Appendix Manifest is the source of truth for recorded days. See [§ +7d cost-watch close-out (CS60-2h)](cs60-data-appendix.md#7d-cost-watch-close-out-cs60-2h). |
| CS60-2e | Day 5 — 2026-04-30. Same daily KQL/cost/metrics pattern as CS60-1c. | ✅ Done | 2026-05-02T18:30Z | Recorded in [`cs60-data-appendix.md`](cs60-data-appendix.md#day-5--2026-04-30-cs60-2e). UTC day fully closed at capture; closed-day Day 5 total 2.54 DKK / 2.07 MB prod AI (re-captured 2026-05-10; original record 2.55 DKK was within ±0.01 rounding). |
| CS60-2f | Day 6 — 2026-05-01. Same daily KQL/cost/metrics pattern as CS60-1c. | ✅ Done (closed-day) | 2026-05-02T18:30Z (orig); re-captured 2026-05-10 | Recorded in [`cs60-data-appendix.md`](cs60-data-appendix.md#day-6--2026-05-01-cs60-2f). **Superseded original "Cost partial (CM lag)" note:** the 2026-05-10 closed-day re-pull (≥9 days after UTC close) confirms the missing `Standard *Idle/Active Usage` meters are a genuine CM compute-meter gap (Days 6-9), NOT lag — see CS60-3 umbrella row Notes for the cross-day finding and recommended follow-up. |
| CS60-2h | Day 7 — 2026-05-02. Canonical "+7d" interpretation point and CS60-2 close. | ✅ Done (closed-day) | 2026-05-02T18:30Z (orig); re-captured 2026-05-10 | Recorded in [`cs60-data-appendix.md`](cs60-data-appendix.md#day-7--2026-05-02-cs60-2h). Original capture was mid-UTC-day (~75 % through). **Superseded original "Recheck during CS60-3i" note:** closed-day re-capture filled workspace ingest (0.03 → 0.08 DKK) but Container Apps compute meters remain absent (same CM gap as Days 6, 8, 9). +7d interpretation refreshed in the close-out section with closed-day data; see CS60-3 umbrella row Notes for the gap finding. |
| CS60-3 | (umbrella) +30d cost-watch window. Daily sub-tasks CS60-3i..CS60-3{?} for Day 8..Day 30 (2026-05-03..2026-05-25). CS60-3{Day30} is the **decision point**: record headroom-vs-5GB-free-tier conclusion. This is the input that CS60-4 / CS60-5 / CS60-6 wait on. | 🟡 In progress (Days 0-14 captured + closed-day; Days 15-30 pending) | 2026-05-03T22:39Z..2026-05-25T22:39Z | Replaces CS54-8 third window. Daily cadence avoids the "skip 23 days then panic" failure mode. **Days 8-14 backfilled 2026-05-10 by yoga-gwn (sub-agent)** — see [`cs60-data-appendix.md` § +14d midpoint roll-up](cs60-data-appendix.md#14d-midpoint-roll-up-cs60-3o) and [§ second-pass projection](cs60-data-appendix.md#cs60-3-second-pass-projection-days-0-14-actuals). **Days 0-7 also re-captured with closed-day CM data** in the same backfill pass — original `Captured:` timestamps preserved with `Re-captured:` annotations; material deltas (Day 1 +1.15 DKK, Day 4 +1.45 DKK) called out per-section. **Material finding:** Days 6-9 (2026-05-01..2026-05-04) show a Cost Management compute-meter gap (no `Standard *Idle/Active Usage` meters emitted for either Container App despite ≥9 days closure) — documented in the +14d roll-up; recommended follow-up CS to file an Azure support ticket / cross-check via Consumption Usage Details API. CS60-3 +30d decision still owed via daily ticks Days 15..30. |
| CS60-3i | Day 8 — 2026-05-03. Same daily KQL/cost/metrics pattern as CS60-1c. | ✅ Done | 2026-05-10 backfill | Recorded in [`cs60-data-appendix.md`](cs60-data-appendix.md#day-8--2026-05-03-cs60-3i). Highest-ingest day in the 14-day window (prod AI 7.50 MB; 8,990 dependencies + 48 exceptions; replicas peaked at 3). UTC day fully closed at capture. **CM compute-meter gap day** — no Container Apps cost meters emitted; only workspace ingestion (0.13 DKK). |
| CS60-3j | Day 9 — 2026-05-04. Same daily KQL/cost/metrics pattern as CS60-1c. | ✅ Done | 2026-05-10 backfill | Recorded in [`cs60-data-appendix.md`](cs60-data-appendix.md#day-9--2026-05-04-cs60-3j). Quiet day; prod AI 0.17 MB / 17 requests. **CM compute-meter gap day** — total cost 0.00 DKK. |
| CS60-3k | Day 10 — 2026-05-05. Same daily KQL/cost/metrics pattern as CS60-1c. | ✅ Done | 2026-05-10 backfill | Recorded in [`cs60-data-appendix.md`](cs60-data-appendix.md#day-10--2026-05-05-cs60-3k). First post-gap day; CM compute meters resume normally (prod 2.12 DKK + staging 0.03 DKK + workspace 0.00 DKK = 2.15 DKK). |
| CS60-3l | Day 11 — 2026-05-06. Same daily KQL/cost/metrics pattern as CS60-1c. | ✅ Done | 2026-05-10 backfill | Recorded in [`cs60-data-appendix.md`](cs60-data-appendix.md#day-11--2026-05-06-cs60-3l). Steady; prod replicas peaked at 2. Total 2.56 DKK. |
| CS60-3m | Day 12 — 2026-05-07. Same daily KQL/cost/metrics pattern as CS60-1c. | ✅ Done | 2026-05-10 backfill | Recorded in [`cs60-data-appendix.md`](cs60-data-appendix.md#day-12--2026-05-07-cs60-3m). Brief staging activity (522 dependencies, 50 requests) — incidental, not a controlled CS60-4 probe. Total 2.67 DKK. |
| CS60-3n | Day 13 — 2026-05-08. Same daily KQL/cost/metrics pattern as CS60-1c. | ✅ Done | 2026-05-10 backfill | Recorded in [`cs60-data-appendix.md`](cs60-data-appendix.md#day-13--2026-05-08-cs60-3n). Highest exception count (68 prod) + first AppTraces row of window. Total 2.66 DKK. |
| CS60-3o | Day 14 — 2026-05-09. Same daily KQL/cost/metrics pattern as CS60-1c. **Canonical "+14d midpoint" interpretation point.** | ✅ Done | 2026-05-10 backfill | Recorded in [`cs60-data-appendix.md`](cs60-data-appendix.md#day-14--2026-05-09-cs60-3o); +14d roll-up added in same PR — see [§ +14d midpoint roll-up](cs60-data-appendix.md#14d-midpoint-roll-up-cs60-3o) and refreshed [§ second-pass projection (Days 0-14 actuals)](cs60-data-appendix.md#cs60-3-second-pass-projection-days-0-14-actuals). 30-day projection: 75-81 DKK/month (≈$10.80-$11.55), 122.7-169.0 MB ingest (2.40-3.30 % of 5 GB free tier). **Free-tier headroom decision: > 4 GB/month margin under every scenario** — CS60-4/5/6 gating input empirically resolved; final confirmation still owed at +30d (2026-05-25). |
| CS60-4 | **Gap 1 — `dependencies` table investigation.** The CS54 done file (Gap 1 + the post-close finding) shows the local OTLP collector receives `execSql gwn` (kind=CLIENT) spans from the `tedious` driver, but `gwn-ai-staging`''s `dependencies` table was empty during CS54-6 verification. Investigate the exporter edge: (a) probe `gwn-ai-staging` with ≥ 20 leaderboard requests; (b) re-run `dependencies | where timestamp > ago(1h)`; (c) if still empty, inspect `instrumentationLibrary.name` on the local `execSql` spans to confirm whether the filter in [`server/telemetry.js:23-27`](../../../server/telemetry.js) drops them on the way to AzMonitorTraceExporter; (d) if filter widening is needed, ship it gated behind container:validate. **Decide-then-do**: if CS60-3 shows headroom > 4GB/month, implement; if headroom ≤ 1GB/month, defer to a future CS and close this task with rationale; if 1-4GB, sample the exporter rather than full-export. | 🟡 Provisional: prod auto-resolved; staging parity still unverified | After CS60-3 final | **Updated 2026-05-02T18:30Z by yoga-gwn during CS60-2 close-out — provisional, NOT yet "auto-resolved":** **Prod side** — `gwn-ai-production` `AppDependencies` is populating every day (Day 4: 465/0.34 MB; Day 5: 2508/1.85 MB; Day 6: 920/0.68 MB; Day 7 partial: 35/0.03 MB; 8-day total ≈ 17.32 MB across the workspace). The `tedious` `execSql` spans ARE flowing through to App Insights. **Filter note:** [`server/telemetry.js:12-27`](../../../server/telemetry.js) explicitly enables only `instrumentation-http` + `instrumentation-express`, so the spans must be bypassing `getNodeAutoInstrumentations()` rather than being admitted by that filter — consistent with the post-CS54 speculation that the `tedious` driver emits OTel client spans directly. Filter-widening work is therefore unlikely to be needed for prod. **Why CS54-6 prod showed 0:** CS54-6's three prod leaderboard probes all hit the `503 capacity-exhausted` path (see `done_cs54...:427-435,563`), making that probe set a non-representative outage-path sample rather than evidence of an exporter bug. **Staging side** — Day 6 produced 69 staging `AppDependencies` rows from incidental deploy/probe traffic (positive signal, but not a controlled verification). Days 5 and 7 staging zeros are non-evidence (CS58 scale-to-zero / no traffic). Still owed: a deliberate ≥ 20-leaderboard-request probe against `gwn-ai-staging` (option (a) of original task) before flipping to "auto-resolved". |
| CS60-5 | **Gap 2 — `traces` table (Pino → AI log forwarding).** CS54-9 Gap 2 recommendation was "stay on cross-table KQL bridge until an incident proves it inadequate." Re-evaluate that recommendation in light of: (a) CS60-3 headroom data; (b) any incident-investigation sessions that ran the bridge query between 2026-04-25 and CS60-3 close. If no incidents proved the bridge inadequate, close as "decided not to do — bridge query in `docs/observability.md` § B.5 is sufficient." If even one incident hit the bridge wall, file a follow-up CS for one of the two implementation options (Pino transport vs OTel logs SDK) — pick based on whichever option the incident artifact most clearly supports. | ⬜ | After CS60-3 | Reads from CS54-9 Gap 2. CS60-3 first-pass already shows 5 GB headroom is not the constraint; final disposition still depends on whether any incident-investigation pain point shows up between now and CS60-3 close. |
...
> **Task mapping note (CS60-1c backfill):** the CS60-1 umbrella row above is preserved as originally claimed for historical context. The missed Day 2 backfill was recorded as CS60-1c after the PR #293/offline window; the appendix Manifest is the source of truth for which UTC days are recorded, and the current +7d split leaves CS60-2g unused as a daily tick.
...
| +7d    | 2026-05-10 (closed-day refresh) | 9.23 (Days 0-7 sum) | 12.70 (Days 0-7 sum) | 8-day cost total **17.76 DKK** (closed-day, vs original recorded 15.11). Per-day workspace-wide ingest 30.18 MB / 8 days = 3.77 MB/day. Days 6-7 CM compute-meter gap noted; Day 1 +1.15 DKK / Day 4 +1.45 DKK material retro-fills. See [§ +7d cost-watch close-out](cs60-data-appendix.md#7d-cost-watch-close-out-cs60-2h). |
| +14d   | 2026-05-10 (CS60-3o) | 9.69 (Days 0-14 sum) | 37.56 (Days 0-14 sum) | 15-day cost total **30.51 DKK** (lag-corrected ≈ 40.4 DKK accounting for Days 6-9 CM compute-meter gap). Per-day workspace-wide ingest 61.31 MB / 15 days = 4.09 MB/day → 122.7 MB/30day = 2.40 % of 5 GB free tier. Steady-state 30-day cost projection 75-81 DKK/month (≈$10.80-$11.55). Prod AI ingest rising 1.59→3.55 MB/day; staging falling 1.16→0.06 MB/day (CS58 fully effective). See [§ +14d midpoint roll-up](cs60-data-appendix.md#14d-midpoint-roll-up-cs60-3o). |
| +30d   | _pending_ | _pending_ | _pending_ | Decision recorded here. Drives CS60-4/5/6. Final confirmation of free-tier headroom > 4 GB/month decision. |
