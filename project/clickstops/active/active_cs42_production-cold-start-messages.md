...
| CS42-3 | ProgressiveLoader 503 auto-retry | ✅ Done | PR [#TBD] — server Retry-After header, RetryableError, timer split, 30s cap, fetchProfile batch promotion, message additions (6s/20s), animated ellipsis |
