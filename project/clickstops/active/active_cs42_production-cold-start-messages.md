...
| CS42-5a | E2E — SW upgrade/migration path | ✅ Done | [PR #TODO](https://github.com/henrik-me/guesswhatisnext/pull/TODO) — `tests/e2e/sw-upgrade.spec.mjs`: seeds bogus `gwn-v2` cache with sentinel, triggers SW update to `gwn-v3`, asserts cache purge + sentinel not served + controllerchange one-shot reload. |
