...
| CS19-4 | Add Docker MSSQL E2E validation | ➡️ Deferred to CS25 | Deferred to [CS25 — MSSQL E2E Testing](planned_cs25_mssql-e2e-testing.md). Docker MSSQL E2E testing requires additional infrastructure setup beyond the scope of the CS19 navigation changes. |
