...
| CS43-6 | Sweep remaining docs for restatements | 🔄 In Progress | PR [#204](https://github.com/henrik-me/guesswhatisnext/pull/204) (omni-gwn/wt-1). Baseline 4 checker violations fixed (INSTRUCTIONS.md anchor, 3 clickstop relative-path links). README.md restatements swept (CS25 "(planned)" framing, Health Monitor cadence → clickable workflow-file pointers). WORKBOARD.md fresh, copilot-instructions.md already pointer-only. LEARNINGS.md CS18/25/38/39 additions + broader README deployment-section restructure deferred to follow-up clickstops (see PR description). |
