...
| CS43-6 | Sweep remaining docs for restatements | 🔄 In Progress | PR #TBD (omni-gwn/wt-1). Baseline 4 checker violations fixed (INSTRUCTIONS.md anchor, 3 clickstop relative-path links). README.md restatements swept (CS25 "(planned)" framing, Health Monitor cadence). WORKBOARD.md fresh, copilot-instructions.md already pointer-only. LEARNINGS.md CS18/25/38/39 additions deferred — prefer follow-up clickstops over superficial additions. |
